...
const ProjectModule = ({ project, index }) => {
  return (
    <motion.div
      ...
      className="glass-panel p-6 rounded-2xl border border-white/5 hover:border-sys-cyan/30 transition-all duration-500 group relative overflow-hidden"
    >
      ...
      <div className="relative z-10">
        <div className="flex justify-between items-start mb-4">
          <div>
            ...
            <h3 className="text-2xl font-light text-white mb-2">{project.displayName}</h3>
          </div>
...
const Projects = () => {
  ...
  return (
    <div className="w-full h-full flex flex-col items-center justify-center px-4 md:px-12 py-20">
